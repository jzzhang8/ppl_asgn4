...
fun compare_flush([],[]) : string = "This is a tie" |
compare_flush((_,hn1)::t1, (_,hn2)::t2) : string = if hn1 = hn2 then compare_flush(t1,t2)
else (if hn2 < hn1 then "Hand 1 wins" else "Hand 2 wins");

(* compare_flush([(Clubs,7),(Clubs,6),(Clubs,5),(Clubs,4),(Clubs,3)],[(Hearts,7),(Hearts,6),(Hearts,4),(Hearts,2),(Hearts,1)]); *)
...
(* test *)
(* check_straight([(Clubs,8),(Spades,7),(Hearts,6),(Clubs,5),(Diamonds,4)]); *)

fun compare_straight([(_,13),(_,12),(_,11),(_,10),(_,1)],[(_,13),(_,12),(_,11),(_,10),(_,1)]) = "This is a tie" |
...
(* compare_straight([(Clubs,13),(Diamonds,12),(Hearts,11),(Clubs,10),(Diamonds,1)],[(Clubs,8),(Clubs,7),(Hearts,6),(Clubs,5),(Diamonds,4)]); *)
...
(* four_of_a_kind([(Diamonds,12),(Spades,10),(Diamonds,10),(Clubs,10),(Hearts,10)]); *)
